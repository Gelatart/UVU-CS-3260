...
namespace LabPhase3
{
    ...
    public class BusinessRules
    {
        ...
        public static SortedDictionary<string, Employee> formerList = new SortedDictionary<string, Employee>();
        public static SortedDictionary<string, Course> courseList = new SortedDictionary<string, Course>();
        ...
        public static string findNullIDDel()
        {
            string id = "BLANK-";
            Random random = new Random();
            int randomNumber = random.Next(0, 1000);
            ...
            {
                int counted = 0;
                foreach (KeyValuePair<string, Employee> worker in formerList)
                {
                    counted++;
                    if (worker.Key == id)
                    {
        ...
        public static string AddEmployeeDel(Form1 form1, Employee emp)
        {
            //indexer to iterate through sortedDict
            string id;
            if (emp == null)
        ...
        public static List<Employee> SearchEmployeeIDDel(string empId)
        {
            Employee emp;
            List<Employee> empList = new List<Employee>();
            foreach (KeyValuePair<string, Employee> worker in formerList)
        ...
        public static List<Employee> SearchEmployeeFirstDel(string firstName)
        {
            List<Employee> empList = new List<Employee>();
            foreach (KeyValuePair<string, Employee> worker in formerList)
            {
        ...
        public static List<Employee> SearchEmployeeLastDel(string lastName)
        {
            List<Employee> empList = new List<Employee>();
            foreach (KeyValuePair<string, Employee> worker in formerList)
            {
        ...
        public static List<Employee> SearchEmployeeFullDel(string fullName)
        {
            List<Employee> empList = new List<Employee>();
            foreach (KeyValuePair<string, Employee> worker in formerList)
            {
